...
TEST(String, to_rgba) {
  ...
  EXPECT_EQ(delta(0x800000ffu, static_cast<unsigned int>(hsla(240, 1, 0.5, 0.5).to_rgba())) & 0xfffefefe, 0);
...
TEST(STring, get_hsla) {
  ...
  EXPECT_EQ("#8000ffff", color_util::hex<unsigned short int>(hsla::get_hsla("hsla(180,1,0.5,0.5)").to_rgba()));
